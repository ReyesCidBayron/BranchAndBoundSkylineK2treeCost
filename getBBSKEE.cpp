...
int main(int argc, char * argv[]){
    ...
    if(alpha == 90) alpha = 89.9999;
    if(beta == 90) beta = 89.9999;
    try{
        ...
        for(int i = 0; i < cycles; i++){
            ...
            // Llama a la función skylineExtendedEuclidean y la almacena en skyline
            skyline = bbske.skylineExtendedEuclidean(kt, alpha, beta);
