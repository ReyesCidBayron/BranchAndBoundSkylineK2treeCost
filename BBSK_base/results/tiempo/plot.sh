...
echo "Compilación: "
g++ timeSkyline.cpp -o timeSkyline
g++ timeCount.cpp -o timeCount
g++ timeEnumerating.cpp -o timeEnumerating
g++ timeConstrained.cpp -o timeConstrained

echo "Procesado de resultados: "
./timeSkyline timeSkyline.out
./timeCount timeCount.out
./timeEnumerating timeEnumerating.out
./timeConstrained timeConstrained.out
